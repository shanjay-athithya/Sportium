      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex gap-16 overflow-x-auto  scrollbar-hide">
          {sports.map((sport) => (
            <div
              key={sport.id}
              className="flex-shrink-0 w-[500px] h-[500px] relative group rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition duration-300 transform hover:scale-105 bg-darkGrey"
            >
              ...
              <div className="absolute bottom-0 w-full px-6 py-4 bg-primaryOrange bg-opacity-90 text-left">
                <h4 className="text-2xl font-bold text-darkGrey mb-2">
                  {sport.name}
                </h4>
                ...
                <Link href={sport.link}>
                  <button className="inline-block bg-primaryOrange text-white py-2 px-6 rounded-full font-bold hover:bg-orange-700 transition duration-200">
                    View Matches
                  </button>
                </Link>
              </div>
